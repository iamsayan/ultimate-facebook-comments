...
function ufc_plugin_register_settings() {
    ...
    add_settings_section('ufc_plugin_option', '', null, 'ufc_plugin_global_section');
        ...
        add_settings_field('ufc_fb_comment_loading_method', __( 'Comments Loading Method:', 'ultimate-facebook-comments' ), 'ufc_fb_comment_loading_method_display', 'ufc_plugin_global_section' , 'ufc_plugin_option', array( 'label_for' => 'fb-comments-load', 'class' => 'fbc-loading' ));
        add_settings_field('ufc_fbc_area_bgcolor', __( 'Comments Background Color:', 'ultimate-facebook-comments' ), 'ufc_fbc_area_bgcolor_display', 'ufc_plugin_global_section' , 'ufc_plugin_option', array( 'label_for' => 'fb-comments-bgcolor' ));
    ...
    add_settings_section('ufc_plugin_notification_option', '', null, 'ufc_plugin_notification_section');
        ...
        add_settings_field('ufc_fbcn_email_recipient', __( 'List of Email Recipient(s):<br><span style=\'font-size:12px\'>(comma separated)</span>', 'ultimate-facebook-comments' ), 'ufc_fbcn_email_recipient_display', 'ufc_plugin_notification_section', 'ufc_plugin_notification_option', array( 'label_for' => 'fbcn-email-receive' ));  
        add_settings_field('ufc_enable_fbcn_author_cb', __( 'Send Notification to Post Author?', 'ultimate-facebook-comments' ), 'ufc_enable_fbcn_author_cb_display', 'ufc_plugin_notification_section', 'ufc_plugin_notification_option', array( 'label_for' => 'fbc-notiauthor' ));  
    ...
    register_setting('ufc_show_plugin_noti_section', 'ufc_plugin_notification_options');
}
