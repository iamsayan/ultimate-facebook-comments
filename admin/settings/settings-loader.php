...
function ufc_plugin_register_settings() {
    ...
    add_settings_section('ufc_plugin_settings_option', __( 'Settings', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'ufc_plugin_settings_section');   
        ...
        add_settings_field('ufc_comment_load_compatibility_mode', __( 'Switch FB SDK Loader Method:', 'ultimate-facebook-comments' ), 'ufc_comment_load_compatibility_mode_display', 'ufc_plugin_settings_section', 'ufc_plugin_settings_option', array( 'label_for' => 'fbc-compatible' ));  
        
    add_settings_section('ufc_plugin_display_option', __( 'Display', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'ufc_plugin_display_section');   
        add_settings_field('ufc_fb_comment_auto_display', __( 'Comments Auto Insert Method:', 'ultimate-facebook-comments' ), 'ufc_fb_comment_auto_display_display', 'ufc_plugin_display_section', 'ufc_plugin_display_option', array( 'label_for' => 'fb-comments-display' ));
    ...
    add_settings_section('ufc_plugin_title_option', __( 'Title', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'ufc_plugin_title_section');     
