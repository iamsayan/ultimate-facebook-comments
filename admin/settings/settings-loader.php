...
function ufc_plugin_register_settings() {
    ...
    add_settings_section('ufc_plugin_option', '', null, 'ufc_plugin_global_section');
        ...
        add_settings_field('ufc_fb_comment_box_width', __( 'Comments Box Width (px):', 'ultimate-facebook-comments' ), 'ufc_fb_comment_box_width_display', 'ufc_plugin_global_section' , 'ufc_plugin_option', array( 'label_for' => 'fb-comments-width' ));
        add_settings_field('ufc_fb_comment_auto_display', __( 'Comments Box Display Position:', 'ultimate-facebook-comments' ), 'ufc_fb_comment_auto_display_display', 'ufc_plugin_global_section' , 'ufc_plugin_option', array( 'label_for' => 'fb-comments-display' ));
        add_settings_field('ufc_fbc_area_bgcolor', __( 'Comments Box Background Color:', 'ultimate-facebook-comments' ), 'ufc_fbc_area_bgcolor_display', 'ufc_plugin_global_section' , 'ufc_plugin_option', array( 'label_for' => 'fb-comments-bgcolor' ));
        add_settings_field('ufc_fb_comment_loading_method', __( 'Comments Box Loading Method:', 'ultimate-facebook-comments' ), 'ufc_fb_comment_loading_method_display', 'ufc_plugin_global_section' , 'ufc_plugin_option', array( 'label_for' => 'fb-comments-load' ));
        ...
        add_settings_field('ufc_fb_sdk_reinit', __( 'Facebook SDK:', 'ultimate-facebook-comments' ), 'ufc_fb_sdk_reinit_display', 'ufc_plugin_global_section' , 'ufc_plugin_option', array( 'label_for' => 'fbc-reinit' ));
        ...
        add_settings_field('ufc_fb_comment_consent_notice_title', __( 'Visitor Notice Title:', 'ultimate-facebook-comments' ), 'ufc_fb_comment_consent_notice_title_display', 'ufc_plugin_global_section', 'ufc_plugin_option', array( 'label_for' => 'fbc-notice-title', 'class' => 'fbc-notice-title' ));  
        add_settings_field('ufc_fb_comment_consent_notice_msg', __( 'Visitor Notice Body Message:', 'ultimate-facebook-comments' ), 'ufc_fb_comment_consent_notice_msg_display', 'ufc_plugin_global_section', 'ufc_plugin_option', array( 'label_for' => 'fbc-notice-msg', 'class' => 'fbc-notice-msg' ));  
