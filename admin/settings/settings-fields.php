...
function ufc_no_of_fb_comments_display() {
    ...
    ?>  <input id="fbc-no" name="ufc_plugin_global_options[ufc_no_of_fb_comments]" type="text" min="1" size="25" style="width:25%;" required placeholder="10" value="<?php if (isset($options['ufc_no_of_fb_comments'])) { echo $options['ufc_no_of_fb_comments']; } ?>" />
...
function ufc_fb_comment_auto_display_display() {
    ...
    $items = array(
        ...
        'disable'                  => 'Disable (use shortcode)'
    );
    echo '<select id="fb-comments-display" name="ufc_plugin_global_options[ufc_fb_comment_auto_display]" style="width:28%;">';
        foreach( $items as $item => $label ) {
    ...
    ?>  <input id="fb-comments-priority" name="ufc_plugin_global_options[ufc_fb_comment_priority]" type="text" size="15" style="width:15%;" value="<?php if (isset($options['ufc_fb_comment_priority'])) { echo $options['ufc_fb_comment_priority']; } ?>" />
    </span>
...
function ufc_comment_area_class_display() {
    ...
    <input id="fbc-area-class" name="ufc_plugin_global_options[ufc_comment_area_class]" type="text" size="35" style="width:35%" placeholder="ufc-comments-area" value="<?php if (isset($options['ufc_comment_area_class'])) { echo $options['ufc_comment_area_class']; } ?>" />
    ...
    <input id="fbc-box-id" name="ufc_plugin_global_options[ufc_comment_area_id]" type="text" size="32" style="width:32%" placeholder="ufc-comments" value="<?php if (isset($options['ufc_comment_area_id'])) { echo $options['ufc_comment_area_id']; } ?>" />
...
function ufc_fb_comment_msg_display() {
    $options = get_option( 'ufc_plugin_global_options' );
    ?><input id="fb-comments-msg" name="ufc_plugin_global_options[ufc_fb_comment_msg]" type="text" size="35" style="width:35%" placeholder="<?php _e( 'Leave a Reply', 'ultimate-facebook-comments' ); ?>" value="<?php if (isset($options['ufc_fb_comment_msg'])) { echo $options['ufc_fb_comment_msg']; } ?>" />
...
function ufc_fb_comment_consent_notice_title_display() {
    ...
    ?>  <input id="fbc-notice-title" name="ufc_plugin_global_options[ufc_fb_comment_consent_notice_title]" type="text" size="70" style="width:70%" placeholder="<?php _e( 'Action Required!', 'ultimate-facebook-comments' ); ?>" value="<?php if (isset($options['ufc_fb_comment_consent_notice_title'])) { echo $options['ufc_fb_comment_consent_notice_title']; } ?>" />
...
function ufc_fb_comment_consent_notice_msg_display() {
    ...
    <textarea id="fbc-notice-msg" name="ufc_plugin_global_options[ufc_fb_comment_consent_notice_msg]" rows="8" cols="75" placeholder="" style="width:75%"><?php if (isset($options['ufc_fb_comment_consent_notice_msg'])) { echo $options['ufc_fb_comment_consent_notice_msg']; } ?></textarea>
...
function ufc_fbcn_name_display() {
    ...
    ?>  <input id="fbcn-name" name="ufc_plugin_global_options[ufc_fbcn_name]" type="text" size="50" style="width:50%;" required placeholder="ex. Your Site Name" value="<?php if (isset($options['ufc_fbcn_name'])) { echo $options['ufc_fbcn_name']; } ?>" />
...
function ufc_fbcn_email_display() {
    ...
    ?>  <input id="fbcn-email" name="ufc_plugin_global_options[ufc_fbcn_email]" type="text" size="50" style="width:50%;" required placeholder="ex. noreply@yoursite.com" value="<?php if (isset($options['ufc_fbcn_email'])) { echo $options['ufc_fbcn_email']; } ?>" />
